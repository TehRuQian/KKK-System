    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        <ul class="list-inline">
          ...
          <li class="list-inline-item">
            <a href="http://www.kada.gov.my/" class="text-white" target="_blank">
              <i class="fa fa-globe fs-4" aria-hidden="true"></i>
            </a>
          </li>
          <li class="list-inline-item">
      ...
      <div class="col-md-4 text-center">
        <h5 class="text-uppercase">Waktu Operasi</h5>
        <ul class="list-unstyled">
          <li>Ahad - Rabu: 08:00 - 17:00</li>
          <li>Khamis: 08:00 - 15:30</li>
          <li>Jumaat: Rehat</li>
          <li>Sabtu: Rehat</li>
        </ul>
      </div>
