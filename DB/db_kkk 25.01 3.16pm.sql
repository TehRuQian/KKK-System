...
CREATE TABLE `tb_member` (
  ...
  `m_homeAddress` varchar(255) NOT NULL,
  ...
  `m_officeAddress` varchar(255) NOT NULL,
...
CREATE TABLE `tb_policies` (
  ...
  `p_minFixedSaving` double NOT NULL COMMENT 'Simpanan Tetap Minimum',
  `p_minMemberFund` double NOT NULL COMMENT 'Sumbangan Tabung Kebajikan Minimum',
  `p_minMemberSaving` double NOT NULL COMMENT 'Wang deposit Anggota Minimum',
