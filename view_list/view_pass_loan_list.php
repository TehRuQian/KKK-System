    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class='text-center'>Jumlah Permohonan (RM)</th>
                <th class='text-center'>Tempoh Pinjaman (Bulan)</th>
                <th class='text-center'>Ansuran Bulanan (RM)</th>
        ...
        <tbody>
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<tr><td colspan='9' class='text-center'>Tiada pinjaman dijelaskan buat masa ini.</td></tr>";
            }
            ?>
        </tbody>
    </table>
